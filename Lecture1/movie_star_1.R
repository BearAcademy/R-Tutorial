...
barplot(table(movie_star$star), family = "wqy-microhei", cex.names = 1.4, ylab = "Number of Movies")

require(showtext)  ### change the fonts
showtext.auto(enable = TRUE)
X11()
barplot(sort(table(movie_star$star), decreasing = T), 
        col = heat.colors(15), family = "wqy-microhei", cex.names = 1.4, ylab = "Number of Movies")
...
barplot(mm[1:4], col = c("#F15854",  "#5DA5DA", "#FAA43A", "#60BD68"), 
        family = "wqy-microhei", cex.names = 1.5)
